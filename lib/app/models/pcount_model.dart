class PcountModel {
  PcountItemModel? result;

  PcountModel({this.result});

  PcountModel.fromJson(Map<String, dynamic> json) {
    result = json['result'] != null ? PcountItemModel?.fromJson(json['result']) : null;
  }
...
class PcountItemModel {
  ...
  PcountItemModel.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
    title = json['title'];
    cid = json['cid'];
    price = json['price'];
